...
public abstract class GrpcClient extends RpcClient {
    ...
    public Connection connectToServer(ServerInfo serverInfo) {
        ...
        try {
            ...
            // 利用requestBiStream()方法生成一个双端流，GrpcConnection的本质就是这个双端流，既可以发送数据，也可以接收数据
            // payloadStreamObserver是用来发送数据的，接收数据的在方法里面定义了
            ...
            // 利用GrpcConnection对象的sendRequest()方法，底层就是利用双端流发送一个ConnectionSetupRequest
