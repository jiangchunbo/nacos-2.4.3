...
public class ConnectionBasedClientManager extends ClientConnectionEventListener implements ClientManager {
    ...
    public boolean clientConnected(String clientId, ClientAttributes attributes) {
        ...
        // 利用ClientFactory根据clientId生成一个Client对象，并保存在clients对应的ConcurrentHashMap中
        // 临时实例对应的就是EphemeralIpPortClientFactory
    ...
    public boolean clientDisconnected(String clientId) {
        ...
        // ClientServiceIndexesManager会处理ClientReleaseEvent事件，移除subscriberIndexes和publisherIndexes中的内容
        NotifyCenter.publishEvent(new ClientOperationEvent.ClientReleaseEvent(client, isResponsible));

        // DistroClientDataProcessor会处理ClientDisconnectEvent事件，同步给其他Server节点
