...
public class SubscribeServiceRequestHandler extends RequestHandler<SubscribeServiceRequest, SubscribeServiceResponse> {
    ...
    public SubscribeServiceResponse handle(SubscribeServiceRequest request, RequestMeta meta) throws NacosException {
        ...
        // Subscriber对应的就是客户端，表示订阅者
        Subscriber subscriber = new Subscriber(meta.getClientIp(), meta.getClientVersion(), app, meta.getClientIp(),
                namespaceId, groupedServiceName, 0, request.getClusters());

        // 本质上就是从publisherIndexes中查询当前service有哪些实例信息
        ...
        if (request.isSubscribe()) {
            // 订阅服务，所谓订阅服务就是往Client的subscribers中，以及ClientServiceIndexesManager的subscriberIndexes中添加记录
        ...
        // 最终返回serviceInfo对象，里面包含了服务的实例信息
