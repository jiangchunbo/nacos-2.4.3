...
public class DistroClientDataProcessor extends SmartSubscriber implements DistroDataStorage, DistroDataProcessor {
    ...
    private void syncToAllServer(ClientEvent event) {
        ...
        if (event instanceof ClientEvent.ClientDisconnectEvent) {
            ...
            // 客户端连接断开，会发布ClientDisconnectEvent事件，此时要通知集群中的其他节点删除对应的服务实例信息
            distroProtocol.sync(distroKey, DataOperation.DELETE);
        } else if (event instanceof ClientEvent.ClientChangedEvent) {
            DistroKey distroKey = new DistroKey(client.getClientId(), TYPE);

            // 当某个client注册服务实例到某个nacos节点后，需要同步给其他nacos节点
    ...
    public boolean processData(DistroData distroData) {
        switch (distroData.getType()) {
            ...
            case DELETE:
                ...
                // 从当前Nacos Server节点上断开deleteClientId对应的client
    ...
    private void handlerClientSyncData(ClientSyncData clientSyncData) {
        ...
        // 将服务实例信息添加到client对象中，clientSyncData就代表了实例信息
    ...
    private void upgradeClient(Client client, ClientSyncData clientSyncData) {
        ...
        // 服务注销的逻辑，当前Client中的服务如果不在syncedService中，就会移除掉
    ...
    public DistroData getDistroData(DistroKey distroKey) {
        ...
        // 核心是client.generateSyncData()，主要是当前client中提供了哪些服务及实例信息
